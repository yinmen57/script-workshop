...
from packages.agent_apps.script_workshop.agents import ALL_AGENTS
from packages.agent_apps.script_workshop.app import APP
from packages.agent_apps.script_workshop.paths import PACKAGE_ROOT
    ...
    tools = [
        {
            ...
            "name": tool_id,
            "description": desc,
            "entrypoint": f"packages.agent_apps.script_workshop.tools:{func_name}",
            "risk_level": "low",
            "parameters": {},
            "source_path": "packages/agent_apps/script_workshop/tools.py",
        }
