...
from business.adapters.media_client import get_image_client, get_video_client
...
from framework.domain.permissions import APP_READ, APP_WRITE
...
async def _project_id_of_narrative_space(
    ...
    from framework.domain.errors import NotFoundError
...
async def get_project_knowledge_status(
    ...
    auth.require(APP_READ)
    from business.script import script_index_service
